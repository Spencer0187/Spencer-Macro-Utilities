...
| `sleep(ms)` | Pause the script for the specified number of milliseconds |
...
| `ui.setDynamicText(id, text)` | Update a dynamic text box value (clamped to 4000 characters, not persisted) |
